...
#ifdef TBG_TBG_BattleGameModeBase_generated_h
#error "TBG_BattleGameModeBase.generated.h already included, missing '#pragma once' in TBG_BattleGameModeBase.h"
#endif
...
public: \
	DECLARE_CLASS(ATBG_BattleGameModeBase, AGameModeBase, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/TBG"), NO_API) \
...
private: \
	...
	ATBG_BattleGameModeBase(const ATBG_BattleGameModeBase&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ATBG_BattleGameModeBase); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ATBG_BattleGameModeBase); \
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(ATBG_BattleGameModeBase) \
